...
<nav class="navbar navbar-expand-sm bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo $link->url('home.index') ?>">
            <img src="<?php echo $link->asset('images/vaiicko_logo.png') ?>" title="<?php echo App\Configuration::APP_NAME ?>" alt="Framework Logo">
        </a>
        <ul class="navbar-nav me-auto">
            <li class="nav-item">
                <a class="nav-link" href="<?php echo $link->url('home.contact') ?>">Contact</a>
            </li>
        </ul>
        <?php if ($user->isLoggedIn()) { ?>
            <span class="navbar-text">Logged in user: <b><?php echo $user->getName() ?></b></span>
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $link->url('auth.logout') ?>">Log out</a>
                </li>
            </ul>
        <?php } else { ?>
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo App\Configuration::LOGIN_URL ?>">Log in</a>
                </li>
            </ul>
        <?php } ?>
    </div>
